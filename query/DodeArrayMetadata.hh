//---------------------------------*-C++-*-----------------------------------//
/*!
 * \file query/DodeArrayMetadata.hh
 * \brief DodeArrayMetadata class declaration
...
//---------------------------------------------------------------------------//
/*!
 * Map rhombic array cells and surfaces to names.
 *
 ...
 */
//---------------------------------------------------------------------------//
class DodeArrayMetadata final : public UniverseMetadata
{
  public:
    //@{
    //! Public type aliases
    ...
    struct Params
    {
        ...
        real_type      apothem; //!< inscribing radius for a given cell
    };
